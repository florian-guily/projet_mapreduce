...
if __name__ == '__main__':
    ...
    HOSTS = ["tp-3a209-10.enst.fr", "tp-1a201-04.enst.fr", "tp-1a201-06.enst.fr", "tp-1a207-23.enst.fr", "tp-1a207-24.enst.fr", "tp-1a207-25.enst.fr"]  # The server's hostname or IP address
